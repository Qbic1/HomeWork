...
public class ProductDaoImpl implements ProductDao
{
    ...
    public int save(Product product)
    {
        try
        {
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO product (name, cost) " +
                    "VALUES (?,?);");
    ...
    public int update(Product product)
    {
        try
        {
            PreparedStatement preparedStatement = connection.prepareStatement("UPDATE product SET cost=? WHERE name=?");
